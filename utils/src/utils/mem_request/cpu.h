...
typedef enum
{
    ...
    LEER_PAG,      // Acceso a página en memoria
    ESCRIBIR_PAG   // Acceso a página en memoria
...
typedef struct
{
    ...
    u_int32_t tamanio_buffer;   // Presente solo para LEER y ESCRIBIR
    void *buffer;               // Presente para ESCRIBIR y ESCRIBIR_PAG
} t_peticion_cpu;
